...
\begin{split}
    ...
    &= \int_{1}^{\infty} f''(\gamma) E_\gamma(\varphi\mid\psi) d\gamma
...
\begin{question}
    Wann ist $D_f(\varphi\mid\psi)$ endlich?
...
\begin{proposition}
    ...
    \gext{($D_f(\varphi\mid\psi)), D_g(\varphi\mid\psi)$ are finite}
    \begin{equation}
...
\begin{split}
    ...
    &= \int_{1}^{\infty} f''(\gamma) E_\gamma(\varphi\mid\psi) d\gamma
    + \int_{0}^{1} \gamma f''(\gamma) E_{\frac{1}{\gamma}}(\psi\mid\varphi) d\gamma\\
    &\oben{=} \int_{1}^{\infty} f''(\gamma) E_\gamma(\varphi\mid\psi) d\gamma
    +\int_{0}^{1}\gamma f''(\gamma)(\frac{1}{\gamma} E_\gamma(\varphi\mid\psi)
    + \psi(\mathbb{1}) - \frac{1}{\gamma}\varphi(\mathbb{1}))
\end{split}
\end{equation}
(a) state exchange, 
\end{proof}